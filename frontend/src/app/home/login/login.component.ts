...
export class LoginComponent implements OnInit {
  loginD: any; //any significa cualquier tipo de dato
  ...
  constructor(
    ...
    this.loginD = {}; // la inicializamos como json vacio
    this.message = '';
  }
  ...
  loginN() {
    if (!this.loginD.email || !this.loginD.password) {
      ...
      this.loginD = {}; //aca se limpia el json para que llene otra vez todos los datos en el formulario
    } else {
      this._userService.login(this.loginD).subscribe(
        ...
        (res) => {
          ...
          this._router.navigate(['/listPost']); //lo redirecciona directo al formulario de crear tarea
          this.loginD = {};
        },
        (err) => {
